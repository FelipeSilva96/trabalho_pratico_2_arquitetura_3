...
module tb_RISCVCPU;
    ...
    task load_program_full_dependencies;
        begin
            ...
            // PC do beq = 56, label está em PC = 68
            // offset = 68 - 56 = 12 bytes
            ...
            // label:
            cpu.IMemory[17] = 32'h00120393; // addi x7, x4, 1       # x7 = resultado final = x4 + 1

            cpu.IMemory[18] = 32'h0000000b; // halt                 # Instrução para finalizar a simulação
        end
    endtask
